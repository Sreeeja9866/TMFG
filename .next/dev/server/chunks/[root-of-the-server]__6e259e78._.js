...
"[project]/TMFG/src/app/api/admin/blog/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const post = await __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].blogPost.findUnique({
            where: {
                id
            }
        });
...
async function PATCH(request, { params }) {
    try {
        ...
        const { title, slug, content, excerpt, author, category, tags, image, published, publishedAt } = body;
        // Check if slug is being changed and if it already exists
        if (slug) {
            const existingPost = await __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].blogPost.findFirst({
                where: {
                    slug,
                    NOT: {
                        id
        ...
        if (published !== undefined) {
            ...
            if (published && !publishedAt) {
                const currentPost = await __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].blogPost.findUnique({
                    where: {
                        id
                    },
                    select: {
        ...
        const post = await __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].blogPost.update({
            where: {
                id
            },
            data: updateData
...
async function DELETE(request, { params }) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$admin$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])();
        const { id } = await params;
        await __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].blogPost.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e259e78._.js.map