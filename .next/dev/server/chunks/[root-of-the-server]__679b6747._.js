...
"[project]/TMFG/src/app/api/admin/services/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { title, slug, description, category, duration, price, maxAttendees, image, active = true } = body;
        ...
        const existingService = await __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].service.findUnique({
            where: {
                slug
            }
        });
        ...
        // Create service
        const service = await __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].service.create({
            data: {
                title,
                slug,
                description,
...
async function GET(request) {
    try {
        ...
        const services = await __TURBOPACK__imported__module__$5b$project$5d2f$TMFG$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].service.findMany({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__679b6747._.js.map